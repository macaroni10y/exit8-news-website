    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="flex justify-between items-center py-2 text-xs sm:text-sm text-gray-600">
            ...
            <div className="flex space-x-3 sm:space-x-4">
              <a
                href="https://github.com/macaroni10y/exit8-news-website"
                target="_blank"
      ...
      <main className="max-w-7xl mx-auto px-3 sm:px-4 py-3 sm:py-6 lg:py-8">
        ...
        <div className="mb-4 sm:mb-6 lg:mb-8">
          <div className="bg-yellow-500 text-white px-3 sm:px-4 py-1.5 sm:py-2 inline-block font-bold text-xs sm:text-sm">
            速報
          </div>
          <div className="bg-white border border-t-0 p-3 sm:p-4 shadow-sm">
            <p className="text-sm sm:text-base lg:text-lg">
              市内で新しい地域活性化プロジェクトが発表されました
            </p>
          </div>
        </div>
              ...
              <div className="max-w-2xl mx-auto mb-6 sm:mb-8 lg:mb-12 text-left">
                ...
                <ul className="space-y-2 sm:space-y-3 text-sm sm:text-base text-gray-700">
                  ...
                  <li className="flex items-start">
                    ...
                    <span>
                      異変があれば「←前の記事へ」、無ければ「次の記事へ→」を選択すること
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="font-semibold mr-2">3.</span>
                    <span>
                      8回連続で正解するとクリア。不正解の場合は最初からやり直し
                    </span>
                  </li>
                </ul>
              </div>
                  ...
                  <div key={i} className="p-3 sm:p-4 hover:bg-gray-50">
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        <a
                          href="#"
                          className="text-sm sm:text-base lg:text-lg font-medium hover:text-yellow-600 line-clamp-2"
                        >
                          {news.title}
                        </a>
